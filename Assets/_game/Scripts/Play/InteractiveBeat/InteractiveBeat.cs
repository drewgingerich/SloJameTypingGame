...
public class InteractiveBeat {
	...
	public InteractiveBeat (float flightTime, float startTimeOffset, AudioSectionPlayerBehavior playheadTracker) {
		FlightTime = flightTime;
		TemporalDistance = flightTime - startTimeOffset;
		playheadTracker.OnChangePosition += UpdateTemporalDistance;
	}
